...
namespace maneuver {
    ...
    /**
     * @brief Class for handling parameters for the FlyToPositionManeuverServer object.
     */
    class FlyToPositionManeuverServerParameters {
    public:
        /**
         * @brief Constructor
         * 
         ...
         */
        FlyToPositionManeuverServerParameters(
         ...
         */
        typedef std::shared_ptr<FlyToPositionManeuverServerParameters> SharedPtr;
