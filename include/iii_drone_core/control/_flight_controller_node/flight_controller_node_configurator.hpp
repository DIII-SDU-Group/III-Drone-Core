...
#include <iii_drone_core/control/behavior_state_parameters.hpp>
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
         * @brief Get the behavior state parameters object
         * 
         * @return Behavior state parameters object reference
         */
        const std::shared_ptr<const control::BehaviorStateParameters> behavior_state_parameters() const;

    private:
        /**
         * @brief Behavior state parameters object
         */
        std::shared_ptr<control::BehaviorStateParameters> behavior_state_parameters_;

        /**
         * @brief BehaviorStateParameters object initialized flag
         */
        bool behavior_state_parameters_initialized_ = false;
        ...
        /**
         * @brief Initializes the behavior state parameters
         */
        void initBehaviorStateParameters();

        /**
         * @brief Callback function called after successful parameter change to update BehaviorStateParameters object.
         */
        void updateBehavorStateParametersObjectCallback(const rclcpp::Parameter & parameter);
