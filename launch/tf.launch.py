...
def generate_launch_description():
    ...
    args = [str(val) for val in params_dict["tf"]["drone_to_cable_gripper"]["value"]] + [drone_frame_id, cable_gripper_frame_id]
    ...
    args = [str(val) for val in params_dict["tf"]["drone_to_mmwave"]["value"]] + [drone_frame_id, mmwave_frame_id]
