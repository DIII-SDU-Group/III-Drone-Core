...
def generate_launch_description():
    ...
    ros_params = os.path.join(iii_config_dir, "ros_params_real.yaml")
    ...
    args = [str(val) for val in params["/tf/drone_to_cable_gripper"]] + [drone_frame_id, cable_gripper_frame_id]
    ...
    args = [str(val) for val in params["/tf/drone_to_mmwave"]] + [drone_frame_id, mmwave_frame_id]
