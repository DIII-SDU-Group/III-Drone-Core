...
cable_takeoff_maneuver_params_t::cable_takeoff_maneuver_params_t() : target_cable_distance(0.0) { }

cable_takeoff_maneuver_params_t::cable_takeoff_maneuver_params_t(float target_cable_distance) : target_cable_distance(target_cable_distance) { }
