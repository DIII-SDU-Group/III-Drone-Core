...
FlightController::FlightController(
	...
	vehicle_odometry_adapter_history_(2) { //,
// request_queue_(1), 
...
// request_completion_poll_rate_(100ms) {
	...
	vehicle_status_sub_ = create_subscription<px4_msgs::msg::VehicleStatus>(
		...
		[this](px4_msgs::msg::VehicleStatus::ConstSharedPtr msg) {
			vehicle_status_adapter_ = iii_drone::adapters::px4::VehicleStatusAdapter(*msg);
		}
	);
	...
	vehicle_odometry_sub_ = this->create_subscription<px4_msgs::msg::VehicleOdometry>(
		...
		[this](px4_msgs::msg::VehicleOdometry::ConstSharedPtr msg) {
			vehicle_odometry_adapter_history_ = iii_drone::adapters::px4::VehicleOdometryAdapter(*msg);
		}
	);
	...
	powerline_sub_ = this->create_subscription<iii_drone_interfaces::msg::Powerline>(
		...
		10,
		[this](iii_drone_interfaces::msg::Powerline::ConstSharedPtr msg) {
			powerline_adapter_history_ = iii_drone::adapters::PowerlineAdapter(*msg);
		}
	);
	...
	gripper_status_sub_ = this->create_subscription<iii_drone_interfaces::msg::GripperStatus>(
		...
		10,
		[this](iii_drone_interfaces::msg::GripperStatus::ConstSharedPtr msg) {
			gripper_status_adapter_.UpdateFromMsg(*msg);
		}
	);
