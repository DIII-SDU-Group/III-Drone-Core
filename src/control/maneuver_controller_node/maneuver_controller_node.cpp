...
void DeclareManagedParameters(LifecycleConfigurator & configurator)
{
    ...
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_gripper_v_gate_apex_z", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_gripper_v_gate_reference_z", double_t);
    ...
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_controller_type", string_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_ascent_velocity", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_max_along_velocity", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_max_cross_velocity", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_max_yaw_rate", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_max_dt_s", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_along_kp", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_along_ki", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_along_kd", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_along_integral_limit", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_cross_kp", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_cross_ki", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_cross_kd", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_cross_integral_limit", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_yaw_kp", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_yaw_ki", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_yaw_kd", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_line_pid_yaw_integral_limit", double_t);
    configurator.DeclareParameter("/control/maneuver_controller/cable_landing_target_lock_max_orthogonal_distance", double_t);
    ...
    configurator.CreateConfiguration("cable_landing_maneuver_server", {
        ...
        ConfigurationEntry("/control/maneuver_controller/cable_landing_gripper_v_gate_apex_z", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_gripper_v_gate_reference_z", double_t),
        ...
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_ascent_velocity", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_max_along_velocity", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_max_cross_velocity", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_max_yaw_rate", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_max_dt_s", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_along_kp", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_along_ki", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_along_kd", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_along_integral_limit", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_cross_kp", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_cross_ki", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_cross_kd", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_cross_integral_limit", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_yaw_kp", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_yaw_ki", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_yaw_kd", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_line_pid_yaw_integral_limit", double_t),
        ConfigurationEntry("/control/maneuver_controller/cable_landing_target_lock_max_orthogonal_distance", double_t),
        ConfigurationEntry("/control/maneuver_controller/maneuver_execution_period_ms", int_t),
        ConfigurationEntry("/control/maneuver_controller/use_gripper_status_condition", bool_t),
