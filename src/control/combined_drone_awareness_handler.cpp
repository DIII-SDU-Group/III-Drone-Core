...
iii_drone::types::transform_matrix_t CombinedDroneAwarenessHandler::ComputeTargetTransform(const iii_drone::adapters::TargetAdapter & target_adapter) const {
    ...
    if (target_adapter.target_type() == iii_drone::adapters::TARGET_TYPE_CABLE) {
        ...
        iii_drone::types::transform_matrix_t d_T_c = target_adapter.target_transform();
        ...
        iii_drone::types::transform_matrix_t w_T_d = w_T_c * d_T_c.inverse();
...
void CombinedDroneAwarenessHandler::SetTarget(const iii_drone::adapters::TargetAdapter & target_adapter) {
